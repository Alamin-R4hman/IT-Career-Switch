...
function calArea(/*This is the parameter*/width, height) {
...
calArea(10, 6) //Argument as values

//In the function call above, the number 10 is passed as the width and 6 is passed as height. Notice that the order in which arguments are passed and assigned follows the order that the parameters are declared.

const recentWidth = 10;
const recentHeight = 6;

calArea(recentWidth, recentHeight);
...
sayThanks('Sid'); // Will print Thank you for your purchase Sid! We appreciate your business.

//If nothing is put in the parameters it will return as undefiend
...
function Calculatearea(width, height) {
  ...
  return/*Return keyword*/ area;/*Return value*/
}
...
//This code defines a function plantNeedsWater that checks if a plant needs water on a given day. It returns true if the day is 'Wednesday' and false otherwise. It then calls the function with ‘Tuesday’ as an example and logs the result to the console, showing false.

//Arrow Functions


/*
ES6 introduced arrow function syntax, a shorter way to write by using the special “fat arrow” () => notation.

Arrow functions remove the need to type out the keyword function every time you need to create a function. Instead, you first include the parameters inside the ( ) and then add an arrow => that points to the function body surrounded in { } like this:
*/

const rectangleArea = (width, height) => /*Instaed of function(width, height)*/ {
  let area = width * height;
  return area;
};
...
//The code defines an arrow function plantNeedsWater that takes a parameter day. It checks if day is 'Wednesday'. If true, it returns true; otherwise, it returns false. This function helps determine watering needs based on the day of the week.
