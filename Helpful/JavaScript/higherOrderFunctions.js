...
functions behave like any other data type in the language; we can assign functions to at a named location in memory.variables, and we can reassign them to new variables.
*/
...
Since functions are a type of object, they have properties such as .length and .name, and methods such as .toString(). You can see more about
...
console.log(isTwoPlusTwo.name)// Will print out original name
...
callBackFunction(fight); //Will execute "one two one two" 3 times like the actual call back function